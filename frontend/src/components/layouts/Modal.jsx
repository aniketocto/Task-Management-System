...
const Modal = ({ children, isOpen, onClose, title }) => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 flex justify-center items-center w-full  max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50 backdrop-blur-[1px]">
